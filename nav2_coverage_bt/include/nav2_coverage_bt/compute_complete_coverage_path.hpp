...
#ifndef NAV2_COVERAGE_BT__COMPUTE_COMPLETE_COVERAGE_PATH_HPP_
#define NAV2_COVERAGE_BT__COMPUTE_COMPLETE_COVERAGE_PATH_HPP_
...
class ComputeCoveragePathAction
  : public nav2_behavior_tree::BtActionNode<
    nav2_complete_coverage_msgs::action::ComputeCoveragePath>
{
  using Action = nav2_complete_coverage_msgs::action::ComputeCoveragePath;
  using ActionResult = Action::Result;

public:
  /**
   * @brief A constructor for nav2_coverage_bt::ComputeCoveragePathAction
...
#endif  // NAV2_COVERAGE_BT__COMPUTE_COMPLETE_COVERAGE_PATH_HPP_
