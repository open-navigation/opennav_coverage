...
> **Note:** This branch migrates `main` to **Fields2Cover v2** (verified against `v2.0.0`), replacing the previous Fields2Cover 1.2.1 dependency. See the companion `humble-v2` branch and the `jazzy-v2` branch for the same upgrade on ROS 2 Humble and Jazzy.
