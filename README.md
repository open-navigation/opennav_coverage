...
> **Note:** This `humble-v2` branch targets **Fields2Cover v2** (verified against `v2.0.0`), as opposed to the `humble` branch which uses Fields2Cover 1.2.1. It will be merged once `main` migrates to F2C v2; until then, use this branch if you need F2C v2 support on ROS 2 Humble.
