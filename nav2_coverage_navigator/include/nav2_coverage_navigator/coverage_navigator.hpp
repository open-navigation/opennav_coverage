...
#ifndef NAV2_COVERAGE_NAVIGATOR__COVERAGE_NAVIGATOR_HPP_
#define NAV2_COVERAGE_NAVIGATOR__COVERAGE_NAVIGATOR_HPP_
...
#include "nav2_complete_coverage_msgs/action/navigate_complete_coverage.hpp"
#include "nav2_util/geometry_utils.hpp"
#include "nav2_util/robot_utils.hpp"
#include "nav_msgs/msg/path.hpp"
#include "nav2_util/odometry_utils.hpp"

namespace nav2_coverage_navigator
{
...
class CoverageNavigator
  : public nav2_core::BehaviorTreeNavigator<
    nav2_complete_coverage_msgs::action::NavigateCompleteCoverage>
{
public:
  using ActionT = nav2_complete_coverage_msgs::action::NavigateCompleteCoverage;
...
#endif  // NAV2_COVERAGE_NAVIGATOR__COVERAGE_NAVIGATOR_HPP_
