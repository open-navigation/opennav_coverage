...
#include "nav2_coverage_navigator/coverage_navigator.hpp"
#include "tf2/utils.h"
...
{
  nav2_coverage_navigator::CoverageNavigator navigator;
...
TEST(CoverageNavigatorTests, TestBasicServer)
{
  ...
  auto action_client =
    rclcpp_action::create_client<nav2_complete_coverage_msgs::action::NavigateCompleteCoverage>(
    client_node, "navigate_complete_coverage");

  auto goal_msg = nav2_complete_coverage_msgs::action::NavigateCompleteCoverage::Goal();
